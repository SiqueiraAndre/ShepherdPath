...
O **ShepherdPath** é um sistema inteligente de gestão de presença para catequese, projetado para eliminar o trabalho manual e repetitivo de coordenadores paroquiais. Desenvolvido com **Laravel 12** e **PostgreSQL** (ou **MySQL**), ele transforma um processo "enrolado" de planilhas em um fluxo automatizado e profissional.
...
- **Ordenação Complexa:** Perda de tempo organizando centenas de catequizandos por catequista e por ordem alfabética toda semana.
...
- 📱 **Check-in Inteligente via QR Code:** Interface *mobile-first* onde o catequizando registra a presença na entrada da missa.
...
- **Banco de Dados:** PostgreSQL (Relacionamentos íntegros e performantes) ou MySQL / MariaDB
- **Cache/Fila:** Redis
...
2. **Registro de Presença:** Na porta da igreja, os catequizandos escaneiam o QR Code para marcar a presença, utilizando uma interface simples e à prova de falhas.
...
---
<p align="center">Feito com ❤️ por André Siqueira para garantir mais tempo na catequese real.</p>